...
class BaryScoreMetric:
    def __init__(self, model_name="bert-base-uncased", last_layers=5, use_idfs=True, sinkhorn_ref=0.01, batch_size=128):
        ...
        # added batch_size:
        # Different batch_size will influence BaryScore a bit, but the fluctuation in average correlations should be <0.003.
    ...
    def evaluate_batch(self, batch_hyps, batch_refs, idf_hyps=None, idf_ref=None):
        ...
        with torch.no_grad():
            ...
            # Disabled tqdm
            for index_sentence in range(nb_sentences):
                dict_score = {}
        ...
        #only outputs baryscore_W
        return baryscores_dic['baryscore_W']
